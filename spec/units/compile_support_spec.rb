...
describe Prawnto::TemplateHandlers::CompileSupport do
  ...
  describe "#set_disposition" do
    before do
      Prawnto::TemplateHandlers::CompileSupport.any_instance.stubs(:set_pragma).returns(true)
      Prawnto::TemplateHandlers::CompileSupport.any_instance.stubs(:set_cache_control).returns(true)
      Prawnto::TemplateHandlers::CompileSupport.any_instance.stubs(:set_content_type).returns(Mime::PDF)
    end
    
    it "default" do
      @headers.expects("[]=").with("Content-Disposition", "inline").once
      Prawnto::TemplateHandlers::CompileSupport.new(@controller)
    end
